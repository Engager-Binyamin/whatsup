...
import delay_between_messages from "./BL/delay";
...
client.on("disconnected", async () => {
  ...
  await deleteFolderRecursive(folder).then(client.initialize());
});
...
client.on("ready", () => {
  ...
  delay_between_messages(sampleData); //שליחת הודעת ניסיון ישירות דרך שרת ווצאפ
});
